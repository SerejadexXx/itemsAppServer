...
var _getFontId = function _getFontId(wb, font) {
    ...
    var fontId = undefined;
    wb.styleData.fonts.forEach(function (f, i) {
        if (_.isEqual(thisFont.toObject(), f.toObject())) {
            fontId = i;
        }
    });
    if (fontId === undefined) {
        var count = wb.styleData.fonts.push(thisFont);
        fontId = count - 1;
    }
...
var _getFillId = function _getFillId(wb, fill) {
    ...
    wb.styleData.fills.forEach(function (f, i) {
        if (_.isEqual(thisFill.toObject(), f.toObject())) {
            fillId = i;
        }
    });
    if (fillId === undefined) {
        var count = wb.styleData.fills.push(thisFill);
        fillId = count - 1;
    }
...
var _getBorderId = function _getBorderId(wb, border) {
    ...
    var borderId = undefined;
    wb.styleData.borders.forEach(function (b, i) {
    ...
    if (borderId === undefined) {
        var count = wb.styleData.borders.push(thisBorder);
        borderId = count - 1;
    }

...
function styleSetter(val) {
    ...
    this.cells.forEach(function (c) {
        var thisCellStyle = thisStyle.toObject();
        if (thisStyle.border && thisStyle.border.outline) {
            var thisCellsBorder = {};
        ...
        if (c.s === 0) {
            if (thisStyle.border && thisStyle.border.outline) {
                thisCellStyle = _this3.ws.wb.createStyle(thisCellStyle);
            } else {
            ...
            var newStyleOpts = _.merge(curStyle.toObject(), thisCellStyle);

...
var DataValidation = function () {
    ...
    function DataValidation(opts) {
        ...
        if (opts.imeMode !== undefined) {
            var enums = ['noControl', 'off', 'on', 'disabled', 'hiragana', 'fullKatakana', 'halfKatakana', 'fullAlpha', 'halfAlpha', 'fullHangul', 'halfHangul'];
        ...
        if (opts.operator !== undefined) {
            var enums = ['between', 'notBetween', 'equal', 'notEqual', 'lessThan', 'lessThanOrEqual', 'greaterThan', 'greaterThanOrEqual'];
        ...
        if (opts.type !== undefined) {
            var enums = ['none', 'whole', 'decimal', 'list', 'date', 'time', 'textLength', 'custom'];
